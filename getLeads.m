...
in
    getResponse2,
        ...
        removeOldDatesToTextTags = Table.ExpandListColumn(removeOldDatesToText, "tags"),
        tagsNew = Table.AddColumn(removeOldDatesToTextTags, "Tags.1", each Text.Combine(Table.FromRecords([tags])[name], ",")),
